...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <form action="{{URL('employee/proccessadd')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="employee_id" name="employee_id" value="{{Request::old('employee_id')}}">
                        <div style="color:red;">{{$errors->first('employee_id')}}</div>
                    </div>
                    <div class="form-group">
                        <label for="birth_city">Birth City </label>
                        <input type="text" class="form-control" id="birth_city" name="birth_city" value="{{Request::old('birth_city')}}">
                        <div style="color:red;">{{$errors->first('birth_city')}}</div>
                    </div>
                    <div class="form-group">
                        <label for="birth">Birth</label>
                        <input type="date" style="width:250px" class="form-control" id="birth" name="birth" value="{{Request::old('birth')}}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control border-0" style="background-color: #F1F2F4;" name="gander" id="gander" value="{{Request::old('gander')}}">
                            <option value="">Choose Gender</option>
                            <option value="male" {{ (Request::old('gander') == 'male') ? 'selected' : '' }}>Male</option>
                            <option value="female" {{ (Request::old('gander') == 'female') ? 'selected' : '' }}>Female</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="id_card_number" name="id_card_number" value="{{Request::old('id_card_number')}}">
                        <div style="color:red;">{{$errors->first('id_card_number')}}</div>
                    </div>
                    <div class="form-group">
                        <label for="id_card_image">ID Card Image </label>
                        <input type="file" class="form-control" id="id_card_image" name="id_card_image" value="{{Request::old('id_card_image')}}">
